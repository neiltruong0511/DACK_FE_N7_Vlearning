...
export default function CourseEnrollmentModal({ isOpen, onClose, maKhoaHoc, tenKhoaHoc }: CourseEnrollmentModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={`Quản lý học viên - Khóa: ${tenKhoaHoc || maKhoaHoc}`} maxWidth="max-w-5xl">
              ...
              <li key={idx} className="flex items-center justify-between rounded-xl border border-slate-100 bg-[#f5f8f8] p-4 shadow-sm transition hover:shadow-md">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-sm text-slate-500">Tài khoản: {user.taiKhoan}</span>
                  </div>
                </div>
