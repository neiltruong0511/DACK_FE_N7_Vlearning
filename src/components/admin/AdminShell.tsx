...
export default function AdminShell({
  ...
  return (
    <div className="min-h-screen bg-[#f5f8f8] text-slate-900">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex w-72 flex-col bg-[#123b3a] px-5 py-6 text-white shadow-2xl transition-transform lg:translate-x-0 ${open ? "translate-x-0" : "-translate-x-full"}`}
      >
        <div className="flex items-center justify-between px-3">
          ...
          >
            ...
            <span>
              ...
              <small className="text-xs text-teal-100/70">
                Quản trị học tập
              </small>
            </span>
          </Link>
        ...
        <div className="mt-12 px-3 text-[11px] font-bold uppercase tracking-[0.18em] text-teal-100/50">
          Không gian quản trị
        </div>
        ...
        <div className="mt-auto border-t border-white/10 pt-4">
          <Link
            href="/"
            className="mb-2 flex items-center gap-3 rounded-xl px-3.5 py-3 text-sm font-semibold text-teal-50/75 hover:bg-white/10 hover:text-white"
          >
          ...
          <button
            ...
            className="flex w-full items-center gap-3 rounded-xl px-3.5 py-3 text-sm font-semibold text-teal-50/75 hover:bg-red-400/15 hover:text-red-100"
          >
